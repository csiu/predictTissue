...
## Extract features from each sample (example)
...
We use `paste -d',' file1 file2 file3 | sed '2,$$s|2|1|g'` to combine the extracted features and to replace bins which overlap 2 peaks (feature value = 2) with a value of 1.
