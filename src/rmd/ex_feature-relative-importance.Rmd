...
Information, data, & examples are from the following:
...
To calculate relative importance, we normalize by all connection weight product sums.
...
The metric is calculated by comparing the connection weights between the input and hidden layer of the initial (un-trained) and trained weights. Note: The connection weights between the hidden and output layer were not used.
